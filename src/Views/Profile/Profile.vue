...
const rules = {
    username: [
        { required: true, message: 'Foydalanuvchi nomi kiritilishi shart', trigger: 'blur' },
...
const handleSaveProfile = async () => {
    try {
        ...
        if (currentPassword || newPassword || confirmPassword) {
            ...
            if (!currentPassword || !newPassword || !confirmPassword) {
                message.warning('Parolni o\'zgartirish uchun barcha maydonlarni to\'ldiring!')
                loading.value = false
                return
            }
            ...
            if (newPassword.length < 8) {
                message.warning('Yangi parol kamida 8 ta belgidan iborat bo\'lishi kerak!')
                loading.value = false
                return
            }
                ...
                >
                    ...
                    <div class="info-section">
                        ...
                        <a-card class="info-card" :bordered="false">
                            ...
                            <template #extra>
                                <a-button v-if="!editMode" type="primary" @click="handleEditToggle" class="action-btn">
                                    <template #icon>
                                        <EditOutlined />
                                    </template>
                                    Tahrirlash
