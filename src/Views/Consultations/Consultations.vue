  ...
  <div class="consultations-container">
    ...
    <div v-else class="consultations-list">
      ...
      <div class="cards-grid">
        <div
          v-for="item in userActiveConsultations"
          :key="item.konsultateId"
          class="consultation-card-wrapper"
        >
          <a-card :hoverable="true" class="consultation-card">
            ...
            <div class="card-footer">
              <a-tag
                :color="item.qabulQilingan ? 'success' : 'processing'"
                class="status-tag"
              >
