  ...
  <div class="branches-container">
    <div class="branches-wrapper">
      ...
      <div class="search-section">
        <Input ref="searchInput" v-model:value="searchText" placeholder="Sizga qulay bo'lgan manzilni kiriting..."
          size="large" allow-clear @pressEnter="handleSearch" class="search-input">
        <template #prefix>
      ...
      <div v-if="filteredBranches.length > pageSize" class="pagination-wrapper">
        <Pagination v-model:current="currentPage" :total="filteredBranches.length" :page-size="pageSize"
          :show-size-changer="false" @change="handlePageChange" :show-total="(total, range) => `${range[0]}-${range[1]} / ${total} ta filial`
            " />
      </div>
        ...
        <div v-if="selectedBranch" class="modal-content">
          ...
          <div class="services-section">
            ...
            <div class="services-tags">
              <a-tag v-for="(service, index) in selectedBranch.services" :key="index" color="blue" class="service-tag">
                {{ service }}
              </a-tag>
            </div>
          </div>
