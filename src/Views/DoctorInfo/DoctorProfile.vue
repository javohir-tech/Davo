      ...
      <template v-else-if="dataById">
        ...
        <a-card class="doctor-card" :bordered="false">
          ...
          <div class="doctor-body">
            ...
            <a-row :gutter="[20, 20]" class="info-grid">
              ...
              <a-col :xs="24" :md="12">
                <a-card class="info-card" size="small">
                  ...
                  <p>
                    <strong>{{ dataById.workPlace.name }}</strong>
                  </p>
            ...
            <a-tag
              color="green"
              style="font-size: 20px; padding: 10px 25px; border-radius: 20px"
            >
        ...
        <a-card v-if="isBooked" class="timeline-card" :bordered="false">
          ...
          <a-result
            status="success"
            title="Konsultatsiyaga muvaffaqiyatli yozildingiz!"
          ...
          <a-timeline mode="left" style="margin-top: 30px">
            ...
            <a-timeline-item :color="isApproved ? 'green' : 'blue'">
              ...
              <p v-if="isApproved">
                Qabul qilindi . Belgilangan vaqtda
                {{ dataById.workPlace.address }} da joylashgan
                {{ dataById.workPlace.name }}mizga kelishizni kutamiz
              </p>
              <p v-else>
          ...
          <a-modal
            title="Kansultatsiyani bekor qilish"
            v-model:open="open"
            :footer="null"
          >
...
<script setup>
  ...
  const TELEGRAM_BOT_TOKEN = import.meta.env
    .VITE_CONSULTATION_TELEGRAM_BOT_TOKEN
  ...
  const handleBooking = async () => {
    ...
    if (selectedDate.value && selectedTime.value) {
      ...
      try {
        ...
        await setDoc(
          doc(db, 'consultations', doctorId, 'doctorConsultations', userId),
          {
