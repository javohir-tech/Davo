<template>
  <div style="background-color: #f5f5f5">
    <div class="medicine-detail-page">
      ...
      <div
        v-else-if="!loading && !dataById"
        style="text-align: center; margin-top: 100px"
      >
        <a-empty />
        <a-button type="primary">
          <RouterLink to="/drugs"> Dorilar </RouterLink>
        </a-button>
      </div>
        ...
        <div class="main-content">
          ...
          <a-card class="medicine-card">
            ...
            <a-space direction="vertical" size="large" style="width: 100%">
              ...
              <div>
                ...
                <a-typography-text
                  v-if="drugStore.isSelected(dataById.id)"
                  type="secondary"
                ...
                >
                  ...
                  {{
                    formatPrice(
                      dataById.price * drugStore.getQuantity(dataById.id)
                    )
                  }}
                  so'm
                </a-typography-text>
              ...
              <div v-if="!drugStore.isSelected(dataById.id)">
                <a-button
                  type="primary"
                  :disabled="drugStore.loadingItems[dataById.id]"
                  size="large"
                  block
                ...
                >
                  ...
                  {{
                    drugStore.loadingItems[dataById.id]
                      ? 'loading...'
                      : "Savatga qo'shish"
                  }}
                </a-button>
              ...
              <div v-else style="display: flex; align-items: center; gap: 12px">
                <a-button
                  size="large"
                  @click="drugStore.decrementQuantity(dataById.id)"
                  :icon="h(MinusOutlined)"
                />
                <a-typography-text
                  strong
                  style="font-size: 18px; min-width: 40px; text-align: center"
                >
                ...
                <a-button
                  size="large"
                  type="primary"
                  @click="drugStore.incrementQuantity(dataById.id)"
                  :icon="h(PlusOutlined)"
                />
              </div>
              ...
              <div>
                <a-typography-text type="secondary"
                  >Ishlab chiqaruvchi:</a-typography-text
                >
                <br />
                <a-typography-text strong>{{
                  dataById.manufacturer
                }}</a-typography-text>
              ...
              <div>
                ...
                <a-space wrap style="margin-top: 8px">
                  <a-tag
                    v-for="cert in dataById.certifications"
                    :key="cert"
                    color="blue"
                  >
          ...
          <a-space direction="vertical" size="middle" style="width: 100%">
            ...
            <a-card size="small">
              ...
              <a-space direction="vertical" size="small">
                <div
                  v-for="(item, index) in dataById.contraindications"
                  :key="index"
                >
            ...
            <a-card size="small">
              <template #title>
                <info-circle-outlined style="color: #faad14" /> Nojo'ya
                ta'sirlar
              </template>
              <a-space direction="vertical" size="small">
            ...
            <!-- Ogohlantirish -->
            <a-alert
              :message="dataById.WarningMessage"
              type="warning"
              show-icon
            >
              <template #icon>
