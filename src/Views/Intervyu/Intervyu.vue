      ...
      <div class="form-wrapper">
        <a-form :model="formState" :rules="rules" :label-col="{ span: 24 }" :wrapper-col="{ span: 24 }"
          ...
          <a-form-item label="To'liq ism" name="fullName" has-feedback>
            <a-input v-model:value="formState.fullName" placeholder="Ismingiz va familiyangizni kiriting" size="large"
              :prefix="h(UserOutlined)" />
          </a-form-item>

          <!-- Yosh -->
          <a-form-item label="Yoshingiz" name="age" has-feedback>
            <a-input-number v-model:value="formState.age" placeholder="Yoshingizni kiriting" size="large" :min="1"
              :max="120" style="width: 100%" />
          </a-form-item>
