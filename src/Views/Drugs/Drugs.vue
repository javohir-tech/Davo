      ...
      <div v-else class="cards-wrapper">
        <Row v-if="paginatedMedicines.length > 0" :gutter="[16, 16]">
          ...
          >
            <div
              class="medicine-card"
              @click="handleCardClick(medicine.id, $event)"
            >
              <!-- Card header -->
              ...
              <div class="card-footer" @click.stop>
                <Button
                  v-if="!drugsStore.isSelected(medicine.id)"
                ...
                >
                  ...
                  {{
                    drugsStore.loadingItems[medicine.id]
                      ? 'Loading...'
                      : 'Savat'
                  }}
                </Button>
                <div v-else class="quatity-control">
                  <Button
                    @click="drugsStore.decrementQuantity(medicine.id)"
                    type="primary"
                    class="cart-btn"
                    :icon="h(MinusOutlined)"
                  />
                  <span class="select-count">{{
                    drugsStore.getQuantity(medicine.id)
                  }}</span>
                  <Button
                    @click="drugsStore.incrementQuantity(medicine.id)"
                    type="primary"
                    class="cart-btn"
                    :icon="h(PlusOutlined)"
                  />
        ...
        <div v-else class="no-results">
          <a-empty
            size="large"
            :description="data.length === 0 ? '' : 'Dori topilmadi'"
          />
        </div>
