<template>
  <div class="services-container">
    <div class="services-page">
      ...
      <!-- Search Section -->
      <div class="header">
        <Input ref="searchInput" v-model:value="search" size="large" placeholder="Xizmatni qidiring..." allow-clear
              ...
              <template #renderItem="{ item }">
                <List-item>
                  <Card hoverable class="doctor-card">
                    ...
                    <Button type="primary" block @click="onSelectDoctor(item.id)" style="margin-top: 10px">
                      <EyeOutlined /> Ko'rish
                    </Button>
                  </Card>
                </List-item>
