  ...
  <div class="article-detail-page">
    ...
    <div v-else-if="dataById && !loading" class="article-container">
      ...
      <div class="article-header">
        <a-tag :color="getCategoryColor(dataById.category)" class="category-tag">
          {{ dataById.category }}
        </a-tag>
      ...
      <div class="article-image-container">
        <img :src="dataById.image" :alt="dataById.title" class="article-image" />
      </div>
      ...
      <div class="article-content">
        ...
        <!-- Maslahatlar bo'limi -->
        <a-card v-if="dataById.tips && dataById.tips.length" title="Foydali maslahatlar" class="tips-card">
          <template #extra>
